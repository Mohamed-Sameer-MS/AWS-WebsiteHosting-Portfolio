...
```bashaws s3 cp s3://webpage1-s3bucket/Portfolio/index.html /var/www/html/index.html 4. Application Load BalancerCreated an internet-facing ALB in public subnets. Registered EC2 in Target Group. Configured health checks for EC2 targets
